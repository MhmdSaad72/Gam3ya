...
class CreateDisabledFamilyDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('disabled_family_details', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('disabled_family_details');
    }
}

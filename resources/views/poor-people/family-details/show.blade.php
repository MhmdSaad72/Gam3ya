...
@section('content')
    <div class="container">
      <a href="{{ url('/poor-people/family-details') }}" title="Back"><button class="btn btn-warning btn-sm no-print"><i class="fa fa-arrow-left" aria-hidden="true"></i> رجوع</button></a>
        <div class="row">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td id="bar" class="d-inline-block text-center barcode">
                                      {{ "2000". $familydetail->care_number }}
                                      <br>
                                      <img src='data:image/png;base64,{{DNS1D::getBarcodePNG("1000".$familydetail->care_number, "C128") }}' alt='barcode' />
                                    </td>

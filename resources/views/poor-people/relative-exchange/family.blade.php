            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                      ...
                      <a href="{{ url('poor-people/relative-exchange/family/excel?id='. $relativeexchange->id) }}" title=""><button class="btn btn-success btn-sm"> اكسل</button></a>
                      <a href="{{ url('/poor-people/relative-exchange/barcodes/' . $relativeexchange->id) }}"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i>  صرف بالباركود</button></a>
                                ...
                                @foreach($families as $item)
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          @else
                                            <form method="POST" action="{{ url('/poor-people/relative-exchange/family' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                              {{ csrf_field() }}

...
@section('title', 'اﻷولاد فوق 16 سنة')

@section('content_header')
    <h1>اﻷولاد فوق 16 سنة</h1>
@stop
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ url('poor-people/males/reports') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">

            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ url('/poor-people/children/' . $child->id . '/edit') }}" title="Edit Child"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> تعديل</button></a>

                        <form method="POST" action="{{ url('poor-people/children' . '/' . $child->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}

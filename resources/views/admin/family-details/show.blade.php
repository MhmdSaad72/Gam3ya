...
@section('content')
    <div class="container">
      <a href="{{ url('/admin/family-details') }}" title="Back"><button class="btn btn-warning btn-sm no-print"><i class="fa fa-arrow-left" aria-hidden="true"></i> رجوع</button></a>

            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ url('/disabled/children/' . $child->id . '/edit') }}" title="Edit Child"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> تعديل</button></a>

                        <form method="POST" action="{{ url('disabled/children' . '/' . $child->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                      <th>  نوع الاعاقة </th><td> {{ $child->disabled->name ?? '' }} </td>
                                    </tr>
                                    <tr>

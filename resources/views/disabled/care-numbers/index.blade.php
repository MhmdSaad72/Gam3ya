            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ url('/disabled/care-numbers') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                            ...
                            <table class="table">
                                ...
                                @forelse ($families as $key => $item)
                                  <tr>
                                    ...
                                    <td>
                                      <a href="{{ url('/disabled/care-numbers/' . $item->id) }}" title="View FamilyDetail"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> عرض البيانات</button></a>
                                    </td>
                                  </tr>
                                @empty
                                  <tr>

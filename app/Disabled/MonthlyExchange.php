...
class MonthlyExchange extends Model
{
     ...
     * @var string
     */
    protected $table = 'disabled_monthly_exchange';
   ...
   public function monthSearch($keyword)
   {
      ...
      elseif (strpos('ابريل' , $keyword) !== false) {return $this->month = 4;}
   ...
   {
     $month = DB::table('disabled_month_costs')->where('monthly_id' , $this->id)->where('checked' , 1)->get();
     return count($month);
   }

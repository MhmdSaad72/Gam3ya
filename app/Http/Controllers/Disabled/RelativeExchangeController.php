...
use DB;
use App\Exports\DisabledRelativeExchangeExport;
...
class RelativeExchangeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('disabled.relative-exchange.index', compact('relativeexchange'));
    }
    ...
    public function create()
    {
        ...
        return view('disabled.relative-exchange.create' , compact('categories'));
    }
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
          ...
          'quantity' => 'required|regex:/^[0-9]+$/|max:6|gte:1',
    		]);
        $requestData = $request->all();

        RelativeExchange::create($requestData);

        return redirect('disabled/relative-exchange')->with('flash_message', 'تم اضافة الصرف العيني!');
    }
    ...
    public function show($id)
    {
        ...
        return view('disabled.relative-exchange.show', compact('relativeexchange'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('disabled.relative-exchange.edit', compact('relativeexchange' , 'categories'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('disabled/relative-exchange')->with('flash_message', 'تم تحديث الصرف العيني!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('disabled/relative-exchange')->with('flash_message', 'تم حذف الصرف العيني!');
    }
...
========================================= */
    public function familyDetails($id)
    {
      ...
      return view('disabled.relative-exchange.family' , compact('families' , 'relativeexchange'));
    }
...
========================================= */
    public function barcodes($id)
    {
      ...
      return view('disabled.relative-exchange.barcodes' , compact('relativeexchange'));
    }
...
========================================= */
    public function checkBarcode(Request $request , $id)
    {
      ...
      if ($family) {
          $checked = DB::table('disabled_relative_costs')->where('family_id' , $family->id)->where('relative_id' ,$relative->id)->first();
...
============================================ */
    ...
    {
      return Excel::download(new DisabledRelativeExchangeExport(), 'Excel.xlsx');
    }
}

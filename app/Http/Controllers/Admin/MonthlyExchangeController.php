...
class MonthlyExchangeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.monthly-exchange.index', compact('monthlyexchanges'));
    }
    ...
    public function create()
    {
        ...
        $month = new MonthlyExchange();
        return view('admin.monthly-exchange.create' , compact('thisYear' , 'month'));
    }
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
    			'year' => 'required',
          'month' => ['required',
          Rule::unique('monthly_exchanges')->where(function ($query) use ($request) {
        ...
        return redirect('admin/monthly-exchange')->with('flash_message', 'تم اضافة صرف شهري!');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.monthly-exchange.show', compact('monthlyexchange'));
    }
    ...
    public function edit($id)
    {
        $monthlyexchange = MonthlyExchange::findOrFail($id);
        $thisYear = \Carbon\Carbon::now()->format('Y') ;
        return view('admin.monthly-exchange.edit', compact('monthlyexchange' , 'thisYear'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/monthly-exchange')->with('flash_message', 'تم تحديث الصرف الشهري!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/monthly-exchange')->with('flash_message', 'تم حذف الصرف الشهري!');
    }
...
================================================= */
    public function familyDetails($id)
    {
      ...
      return view('admin.monthly-exchange.family' , compact('families' , 'monthlyexchange' , 'year' , 'month'));
    }
...
========================================= */
    public function barcodes($id)
    {
      ...
      return view('admin.monthly-exchange.barcodes' , compact('monthlyexchange'));
    }
...
========================================= */
    public function checkBarcode(Request $request , $id)
    {
      ...
      if ($family) {
          $checked = DB::table('month_costs')->where('family_id' , $family->id)->where('monthly_id' ,$month->id)->first();
...
=========================================== */
    ...
    {
      return Excel::download(new MonthlyExchangeExport(), 'Excel.xlsx');
    }
}

...
class ChildrenController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.children.create', compact('child' , 'families'  , 'orphanSponsers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/children')->with('flash_message', 'تم اضافة طفل!');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.children.show', compact('child' , 'families'  , 'orphanSponsers'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.children.edit', compact('child' , 'families' , 'orphanSponsers'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/children')->with('flash_message', 'تم تحديث الطفل!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/children')->with('flash_message', 'تم حذف الطفل!');
    }
}

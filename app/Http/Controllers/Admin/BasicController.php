...
class BasicController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/basic')->with('flash_message', 'تم اضافة اﻷساسيات!');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.basic.show', compact('basic'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/basic')->with('flash_message', 'تم تحديث اﻷساسيات!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/basic')->with('flash_message', 'تم حذف اﻷساسيات!');
    }
}
